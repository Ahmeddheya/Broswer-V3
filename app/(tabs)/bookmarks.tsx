...
const BookmarksScreen = () => {
  ...
  const createFolder = () => {
    if (newFolderName.trim() && !folders.includes(newFolderName.trim())) {
      ...
      showToast(`تم إنشاء مجلد "${newFolderName.trim()}" بنجاح`);
    } else {
      showToast('يرجى إدخال اسم مجلد صحيح غير موجود مسبقاً', 'error');
    }
  };
  ...
  const moveBookmarkToFolder = (bookmarkId: string, targetFolder: string) => {
    ...
    if (bookmark) {
      ...
      showToast(`تم نقل المفضلة إلى مجلد "${targetFolder}"`);
    }
  };
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: () => {
            ...
            showToast(`تم حذف مجلد "${folderName}" بنجاح`);
          }
        }
      ]
    );
      ...
      <View style={styles.searchContainer}>
        ...
        {isLoading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>Start bookmarking your favorite sites</Text>
          </View>
        ) : (
          <FlatList
